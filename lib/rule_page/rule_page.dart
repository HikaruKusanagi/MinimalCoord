        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('「MinimalCoord利用規約」（以下「本利用規約」といいます。）は、'
                  'MinimalCoord（以下「本アプリケーション」といいます。）において提供する'
              ...
              Text(
                '本サービスはAppleSignIn、GogleSignInを利用し、アプリを使用します。'
              ),
              SizedBox(
                height: 16.0,
              ),
              ...
              Text(
                '• MinimalCoordに関係のないコンテンツや画像を投稿する行為\n'
              ...
              Text('ユーザーが公開した画像が'
                  ...
                  'MinimalCoordとは関係のない、またはその他の不適切なコンテンツが含まれる可能性があります。'
                  '本サービスを利用する前提として、そのようなコンテンツを目にする可能性があることを'
                  '了承しているものとします。'
                  'ただし、そのような不適切なユーザー、画像、を見つけた場合には、'
                  'アプリ内の通報用のアイコンボタンより、該当するコンテンツの情報を'
                  'サービス運営にお知らせ下さい。可及的速やかに内容を確認し、サービス運営者が'
                  '必要と判断した場合には、該当する画像を削除したり、該当する画像を'
